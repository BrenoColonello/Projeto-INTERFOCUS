-- Inserindo 30 usuarios
INSERT INTO mutuario (nome, cpf, nascimento, email)
VALUES ('Alice Souza', '19026689012', '1990-01-01', 'alice.souza@example.com'),
...
('Joao Pinto', '64719396046', '1979-10-26', 'joao.pinto@example.com'),
...
('Olivia Goncalves', '19449384002', '1986-03-24', 'olivia.goncalves@example.com'),
...
('Sofia Araujo', '45636878044', '1987-07-10', 'sofia.araujo@example.com'),
...
-- Inserindo 50 dividas
INSERT INTO divida (valor, situacao, descricao, id_cliente)
VALUES 
(50.00, false, 'Compra de materiais', 1),
(30.00, true, 'Pagamento de servicos', 1),
(100.00, false, 'Servico de manutencao', 2),
(20.00, true, 'Compra de suprimentos', 2),
(150.00, false, 'Pagamento de aluguel', 3),
(10.00, true, 'Compra de alimentos', 3),
(70.00, false, 'Servico de limpeza', 4),
(40.00, true, 'Compra de vestuario', 4),
(60.00, false, 'Pagamento de contas', 5),
(50.00, true, 'Compra de eletronicos', 5),
(90.00, false, 'Servico de transporte', 6),
(50.00, true, 'Compra de remedios', 6),
(110.00, false, 'Pagamento de impostos', 7),
(20.00, true, 'Compra de livros', 7),
(80.00, false, 'Servico de jardinagem', 8),
(30.00, true, 'Compra de moveis', 8),
(40.00, false, 'Pagamento de servicos', 9),
(100.00, true, 'Compra de materiais', 9),
(50.00, false, 'Servico de manutencao', 10),
(30.00, true, 'Compra de suprimentos', 10),
(70.00, false, 'Pagamento de aluguel', 11),
(60.00, true, 'Compra de alimentos', 11),
(50.00, false, 'Servico de limpeza', 12),
(40.00, true, 'Compra de vestuario', 12),
(100.00, false, 'Pagamento de contas', 13),
(20.00, true, 'Compra de eletronicos', 13),
(150.00, false, 'Servico de transporte', 14),
(10.00, true, 'Compra de remedios', 14),
(90.00, false, 'Pagamento de impostos', 15),
(50.00, true, 'Compra de livros', 15),
(110.00, false, 'Servico de jardinagem', 16),
(20.00, true, 'Compra de moveis', 16),
(80.00, false, 'Pagamento de servicos', 17),
(30.00, true, 'Compra de materiais', 17),
(40.00, false, 'Servico de manutencao', 18),
(100.00, true, 'Compra de suprimentos', 18),
(50.00, false, 'Pagamento de aluguel', 19),
(30.00, true, 'Compra de alimentos', 19),
(70.00, false, 'Servico de limpeza', 20),
(60.00, true, 'Compra de vestuario', 20),
(50.00, false, 'Pagamento de contas', 21),
(40.00, true, 'Compra de eletronicos', 21),
(100.00, false, 'Servico de transporte', 22),
(20.00, true, 'Compra de remedios', 22),
(150.00, false, 'Pagamento de impostos', 23),
(10.00, true, 'Compra de livros', 23),
(90.00, false, 'Servico de jardinagem', 24),
(50.00, true, 'Compra de moveis', 24),
(110.00, false, 'Pagamento de servicos', 25),
(20.00, true, 'Compra de materiais', 25),
(80.00, false, 'Servico de manutencao', 26),
(30.00, true, 'Compra de suprimentos', 26),
(40.00, false, 'Pagamento de aluguel', 27),
(100.00, true, 'Compra de alimentos', 27),
(50.00, false, 'Servico de limpeza', 28),
(30.00, true, 'Compra de vestuario', 28),
(70.00, false, 'Pagamento de contas', 29),
(60.00, true, 'Compra de eletronicos', 29),
(50.00, false, 'Servico de transporte', 30),
(40.00, true, 'Compra de remedios', 30);

-- Assegurando que nenhum usuario tenha mais de 200 reais em dividas